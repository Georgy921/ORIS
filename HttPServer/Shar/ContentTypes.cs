...
namespace HttPServer.Utils
{
    ...
    {
        private static readonly Dictionary<string, string> _typesExtesionsDict = new Dictionary<string, string>
        {
        ...
        {
            return _typesExtesionsDict.TryGetValue(new FileInfo(path).Extension, out var ext) ? ext : "text/html";
        }

        public static string GetContentTypeByExtension(string extension)
        {
            return _typesExtesionsDict.TryGetValue(extension, out var ext) ? ext : "text/html";
        }
    }
